...
![PAT](PAT.png)
> * En este ejemplo queremos que la red privada 192.168.10.0/24 salga hacia afuera nateada por el rango público: 11.11.11.1 ~ 11.11.11.5 haciendo sobrecarga de puertos.
